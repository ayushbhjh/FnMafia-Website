...
export default function Contact() {
  ...
  return (
    ...
    <div className="flex justify-center items-centre gap-5 p-20 w-full h-screen text-white">
      {/* <div class=" flex   h-5/6 flex-col justify-center px-6 py-12 lg:px-8 w-9/12 bg-gray-300  left-4  top-10 rounded-lg pt-26">
...
<div className="flex mt-4">
          ...
          <div className="mt-5">
            ...
            <p className="text-sm mt-3">
              Delhi Office: FnMafia, Somdutt Chamber 1,5,<br /> Bhikaji Cama Place,
              Rama Krishna Puram, New Delhi 110066. <br /> Registered Office:
              FnMafia <br />c/o FLIVE Consulting Private Limited, <br /> #6317, B9, Vasant
              Kunj, New Delhi - 110070
            </p>
          </div>
        </div>
        <div className="flex ">
          <div className="h-48 w-48 mt-2">
            <img
      ...
      {/* <div className="w-6/12  bg-blue-600 h-5/6  top-10 right-5  rounded-r-lg text-white pt-20">
        <div className="flex mt-4">
